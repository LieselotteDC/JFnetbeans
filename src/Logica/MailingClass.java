...
public class MailingClass {
    ...
    public void sendBesteldeProductenVanOrder(Take_Away takeaway, String bestandsnaam) {
        ...
        try {
            ...
            String htmlText = "<font color='#FF9933' size='+2'>Beste " + takeaway.getNaam() + ",</font>"
                    ...
                    + "Indien u vragen heeft over deze bestelling,<br> "
    ...
    public void sendBestellingNaarKlant(Klant kl, String bestandsnaam) {
        // Recipient's email ID needs to be mentioned.
        String to = kl.getEmail();
        ...
        try {
            ...
            BodyPart messageBodyPart = new MimeBodyPart();
            String htmlText = "<font color='#FF9933' size='+2'>Welkom " + kl.getVoornaam() + " " + kl.getNaam() + ",</font>"
                    + "<P>bedankt voor je bestelling bij Just-Feed!<br> "
                    + "In de bijlage vind je meer info over je bestelling."
                    + "Indien u vragen heeft over deze bestelling,<br> "
                    + "aarzel dan niet om ons te contacteren op het onderstaande e-mailadres.</P>"
                    + "<br><img src=\"cid:image\"> <br>"
                    + "<i><b>Het team van Just-Feed</b><br>"
